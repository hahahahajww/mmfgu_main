...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(
        description="FedKD baseline for federated client unlearning"
    )
    ...
    parser.add_argument("--distill-lr", type=float, default=Config.distill_lr)
    parser.add_argument(
        "--distill-temperature", type=float, default=Config.distill_temperature
    )
